            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex space-x-4 ml-auto">
                        <Link to="/dashboard" className="px-4 py-1 rounded-full bg-indigo-600 text-white text-sm hover:bg-indigo-700 transition">
                            Dashboard
                        </Link>
                        <Link to="/login" className="px-4 py-1 rounded-full border border-indigo-400 text-indigo-400 text-sm hover:bg-indigo-600 hover:text-white transition">
                            Login
                        </Link>
                    </div>
